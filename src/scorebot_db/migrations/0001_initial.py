# Generated by Django 2.1 on 2018-08-06 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#d3dba6', max_length=9, verbose_name='Membership Color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subclass', models.SmallIntegerField(choices=[(0, 'Team'), (1, 'ScoreTeam'), (2, 'PlayerTeam')], default=None, editable=False, null=True, verbose_name='Team SubClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subclass', models.SmallIntegerField(choices=[(0, 'Transaction'), (1, 'Payment'), (2, 'Transfer'), (3, 'Purchase'), (4, 'Correction'), (5, 'PaymentHealth'), (6, 'TransferResult'), (7, 'TransactionFlag'), (8, 'TransactionBeacon')], default=None, editable=False, null=True, verbose_name='Team SubClass')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='game',
            name='goldteam',
            field=models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gold', to='scorebot_db.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='ports',
        ...
        migrations.AddField(
            model_name='transaction',
            name='destination',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score_destination', to='scorebot_db.ScoreTeam'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='score_source', to='scorebot_db.ScoreTeam'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='game',
            name='grayteam',
            field=models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gray', to='scorebot_db.ScoreTeam'),
        ),
        migrations.AddField(
            model_name='range',
            name='team',
